    ...
    parseString(sample_round_xml, function (err, sample_round_json) {
        ...
        parseString(matches_string, function (err, matches_json) {
            ...
            describe('#toJson()', function () {
                it('will include the number', function () {
                    assert.equal(sample_round.toJson().number, ANY_NUMBER);
                });
                it('will include the type', function () {
                    assert.equal(sample_round.toJson().type, ANY_TYPE);
                });
